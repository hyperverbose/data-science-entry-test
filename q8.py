...
# Your answer (Reason 1): Prompt B makes use of structured prompts and lists, which helps produce a more
# organised response. Describing multiple complex requests in a single statement might not be parsed well by the AI.
# Your answer (Reason 2): Prompt B is written with relatively more concise language and is more specific
# (e.g. B's constraints v.s. A's "a way that is easy to understand")

# Q8c: What is ONE strength of the prompt you did NOT choose?
# Your answer: Prompt A communicates the background and context better (while B's is more general/vague),
# which can help generate answers that are more relevant to the user's needs.


# Task 2
# Rewrite either prompt by borrowing ONE element from the other
# to make it stronger. Explain what you borrowed and why.
# Your answer: Step 2 in prompt B ("Extract the most common themes from the written comments") is a very broad
# request and also might be interpreted oddly. I clarified this step using detail from prompt A ("common complaints")
